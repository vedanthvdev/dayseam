...
| **v0.2. Atlassian (Jira + Confluence)** | [`2026-04-20-v0.2-atlassian.md`](./2026-04-20-v0.2-atlassian.md) | Atlassian Cloud support: Jira issue transitions + comments + assignments, Confluence page-created/edited + comments, one email+API-token credential shared across both products, sibling `connector-jira` + `connector-confluence` crates backed by shared `connector-atlassian-common`, cross-source enrichment linking GitLab MRs ↔ Jira issues (ticket-key extraction from commit titles + reverse-lookup transition annotation). Seeded by [`docs/spikes/2026-04-20-atlassian-connectors-data-shape.md`](../spikes/2026-04-20-atlassian-connectors-data-shape.md). |
